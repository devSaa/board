        ...
        <form method="POST" action="{{ route('admin.pages.store') }}">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select id="parent" class="form-control{{ $errors->has('parent') ? ' is-invalid' : '' }}"
                            name="parent">
                        <option value=""></option>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            CKEDITOR.replace('content', {filebrowserUploadUrl: window.location.protocol + '//' + window.location.hostname + ((window.location.port) ? ':' + window.location.port : '') + '/admin/ajax/upload/image'});
        });
    </script>
@stop